...
var authConfig = {
  ...
  main_color: 'cyan', // red | pink | purple | deep-purple | indigo | blue | light-blue | cyan | teal | green | light-green | lime yellow | amber orange | deep-orange | brown | greyblue-grey
  accent_color: 'light-blue', // red | pink | purple | deep-purple | indigo | blue | light-blue | cyan | teal | green | light-green | lime | yellow | amber | orange | deep-orange
  dark_theme: true, // true for dark theme
  // client_id & client_secret - PLEASE USE YOUR OWN!
  client_id: '202264815644.apps.googleusercontent.com',
  client_secret: 'X4Z3ca8xfWDb1Voo-F9a7ZxJ',
  refresh_token: '1//0dLPYmCmKMQUNCgYIARAAGA0SNwF-L9IrbeMvKWbIrn7YQgD7Z379bnVIGtVBvYIeiEgLXHbYO9k4-ffHerCC-clyyEwubGVsFOs', // Refresh token
...
   * No need for Basic Auth disk, just keep user and pass empty at the same time. (No need to set it directly)
  ...
  roots: [
    ...
    {
      id: '0AMW2nbIN03isUk9PVA',
      name: 'Noobie Collection',
      user: '',
      pass: ''
    },
    {
